...
class SignInUsernamePostRequest(BaseModel):
    """
    ...
    remember_me: Optional[StrictBool] = Field(default=None, description="Remember the user session", alias="rememberMe")
    ...
    __properties: ClassVar[List[str]] = ["username", "password", "rememberMe", "callbackURL"]
