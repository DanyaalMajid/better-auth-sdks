...
class PhoneNumberForgetPasswordPostRequest(BaseModel):
    """
    PhoneNumberForgetPasswordPostRequest
    """ # noqa: E501
    phone_number: StrictStr = Field(description="The phone number which is associated with the user. Eg: \"+1234567890\"", alias="phoneNumber")
