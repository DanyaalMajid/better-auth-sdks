...
class ForgetPasswordEmailOtpPost200Response(BaseModel):
    """
    ForgetPasswordEmailOtpPost200Response
    """ # noqa: E501
    success: Optional[StrictBool] = Field(default=None, description="Indicates if the OTP was sent successfully")
