...
class Oauth2ConsentPost200Response(BaseModel):
    """
    Oauth2ConsentPost200Response
    """ # noqa: E501
    redirect_uri: StrictStr = Field(description="The URI to redirect to, either with an authorization code or an error", alias="redirectURI")
