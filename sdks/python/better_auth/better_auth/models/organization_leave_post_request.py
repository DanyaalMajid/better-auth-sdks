...
class OrganizationLeavePostRequest(BaseModel):
    """
    OrganizationLeavePostRequest
    """ # noqa: E501
    organization_id: StrictStr = Field(description="The organization Id for the member to leave. Eg: \"organization-id\"", alias="organizationId")
