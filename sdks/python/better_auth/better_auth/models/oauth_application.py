...
class OauthApplication(BaseModel):
    ...
    redirect_urls: Optional[StrictStr] = Field(default=None, alias="redirectURLs")
    type: Optional[StrictStr] = None
    disabled: Optional[StrictBool] = False
    user_id: Optional[StrictStr] = Field(default=None, alias="userId")
    created_at: Optional[StrictStr] = Field(default=None, alias="createdAt")
    updated_at: Optional[StrictStr] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["id", "name", "icon", "metadata", "clientId", "clientSecret", "redirectURLs", "type", "disabled", "userId", "createdAt", "updatedAt"]
