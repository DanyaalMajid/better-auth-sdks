...
class Oauth2RegisterPost200Response(BaseModel):
    """
    ...
    client_secret: StrictStr = Field(description="Secret key for the client", alias="clientSecret")
    ...
    def authentication_scheme_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['client_secret']):
            raise ValueError("must be one of enum values ('client_secret')")
        return value
