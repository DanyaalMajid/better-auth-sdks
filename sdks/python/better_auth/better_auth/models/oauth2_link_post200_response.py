...
class Oauth2LinkPost200Response(BaseModel):
    """
    Oauth2LinkPost200Response
    """ # noqa: E501
    url: StrictStr = Field(description="The authorization URL to redirect the user to for linking the OAuth2 account")
    redirect: StrictBool = Field(description="Indicates that the client should redirect to the provided URL")
    __properties: ClassVar[List[str]] = ["url", "redirect"]
