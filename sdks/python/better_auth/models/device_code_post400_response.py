...
class DeviceCodePost400Response(BaseModel):
    """
    ...
    def error_validate_enum(cls, value):
        ...
        if value not in set(['invalid_request', 'invalid_client']):
            raise ValueError("must be one of enum values ('invalid_request', 'invalid_client')")
        return value
