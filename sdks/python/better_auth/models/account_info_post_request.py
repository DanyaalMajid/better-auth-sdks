...
class AccountInfoPostRequest(BaseModel):
    """
    AccountInfoPostRequest
    """ # noqa: E501
    account_id: StrictStr = Field(description="The provider given account id for which to get the account info", alias="accountId")
