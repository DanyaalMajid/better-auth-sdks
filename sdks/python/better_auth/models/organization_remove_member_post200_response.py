...
class OrganizationRemoveMemberPost200Response(BaseModel):
    """
    OrganizationRemoveMemberPost200Response
    """ # noqa: E501
    member: OrganizationGetActiveMemberGet200Response
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "member": OrganizationGetActiveMemberGet200Response.from_dict(obj["member"]) if obj.get("member") is not None else None
        })
        return _obj
