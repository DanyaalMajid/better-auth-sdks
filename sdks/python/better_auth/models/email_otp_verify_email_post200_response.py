...
class EmailOtpVerifyEmailPost200Response(BaseModel):
    """
    EmailOtpVerifyEmailPost200Response
    """ # noqa: E501
    status: Optional[StrictBool] = Field(default=None, description="Indicates if the verification was successful")
    token: Optional[StrictStr] = Field(default=None, description="Session token if autoSignInAfterVerification is enabled, otherwise null")
