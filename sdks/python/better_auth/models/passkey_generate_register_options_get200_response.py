...
class PasskeyGenerateRegisterOptionsGet200Response(BaseModel):
    """
    ...
    pub_key_cred_params: Optional[List[PasskeyGenerateRegisterOptionsGet200ResponsePubKeyCredParamsInner]] = Field(default=None, alias="pubKeyCredParams")
    timeout: Optional[Union[StrictFloat, StrictInt]] = None
    exclude_credentials: Optional[List[PasskeyGenerateRegisterOptionsGet200ResponseExcludeCredentialsInner]] = Field(default=None, alias="excludeCredentials")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pubKeyCredParams": [PasskeyGenerateRegisterOptionsGet200ResponsePubKeyCredParamsInner.from_dict(_item) for _item in obj["pubKeyCredParams"]] if obj.get("pubKeyCredParams") is not None else None,
            "timeout": obj.get("timeout"),
            "excludeCredentials": [PasskeyGenerateRegisterOptionsGet200ResponseExcludeCredentialsInner.from_dict(_item) for _item in obj["excludeCredentials"]] if obj.get("excludeCredentials") is not None else None,
