...
class DeviceGet200Response(BaseModel):
    """
    DeviceGet200Response
    """ # noqa: E501
    user_code: Optional[StrictStr] = Field(default=None, description="The user code to verify")
    status: Optional[StrictStr] = Field(default=None, description="Current status of the device authorization")
    __properties: ClassVar[List[str]] = ["user_code", "status"]
