...
class DeviceTokenPost400Response(BaseModel):
    """
    ...
    def error_validate_enum(cls, value):
        ...
        if value not in set(['authorization_pending', 'slow_down', 'expired_token', 'access_denied', 'invalid_request', 'invalid_grant']):
            raise ValueError("must be one of enum values ('authorization_pending', 'slow_down', 'expired_token', 'access_denied', 'invalid_request', 'invalid_grant')")
        return value
