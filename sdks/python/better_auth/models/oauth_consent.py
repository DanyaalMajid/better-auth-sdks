...
class OauthConsent(BaseModel):
    ...
    consent_given: Optional[StrictBool] = Field(default=None, alias="consentGiven")
    __properties: ClassVar[List[str]] = ["id", "clientId", "userId", "scopes", "createdAt", "updatedAt", "consentGiven"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consentGiven": obj.get("consentGiven")
        })
        return _obj
