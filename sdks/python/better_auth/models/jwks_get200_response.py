...
class JwksGet200Response(BaseModel):
    """
    JwksGet200Response
    """ # noqa: E501
    keys: List[JwksGet200ResponseKeysInner] = Field(description="Array of public JSON Web Keys")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keys": [JwksGet200ResponseKeysInner.from_dict(_item) for _item in obj["keys"]] if obj.get("keys") is not None else None
        })
        return _obj
